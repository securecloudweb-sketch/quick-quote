...
export const insuranceProducts: Product[] = [
  {
    ...
    fields: [
      ...
      },
      {
        ...
        options: [
          { value: "theft", label: "Theft protection", amount: 85 },
          { value: "flood", label: "Flood protection", amount: 60 },
          { value: "windscreen", label: "Windscreen protection", amount: 45 },
          { value: "accident", label: "Personal accident cover", amount: 55 },
        ],
      },
    ],
  },
